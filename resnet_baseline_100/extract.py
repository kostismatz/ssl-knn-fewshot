...
def main(args):
    ...
    os.makedirs("features_resnet100", exist_ok=True)
    
    train_out_path = "features_resnet100/cifar100_train.pt"
    test_out_path = "features_resnet100/cifar100_test.pt"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", type=str, default="checkpoints_resnet100/best_model.pt", help="Path to trained checkpoint")
