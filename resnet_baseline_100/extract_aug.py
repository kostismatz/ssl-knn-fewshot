...
def main(args):
    ...
    os.makedirs("features_resnet100_aug", exist_ok=True)
    
    train_out_path = "features_resnet100_aug/cifar100_train.pt"
    test_out_path = "features_resnet100_aug/cifar100_test.pt"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", type=str, default="checkpoints_resnet100_aug/best_model.pt", help="Path to trained checkpoint")
