...
if __name__ == "__main__":
    train = torch.load("features_resnet100_aug/cifar100_train.pt")
    test = torch.load("features_resnet100_aug/cifar100_test.pt")
    ...
    plt.title('Few-Shot KNN Accuracy (CIFAR-100 Augmented ResNet-50)', fontsize=14)
    plt.xlabel('Number of Shots per Class (N)', fontsize=12)
    plt.ylabel('Accuracy', fontsize=12)
    
    plt.tight_layout()
    plt.savefig('results_resnet100_aug.png', dpi=300)
    print("Saved plot to results_resnet100_aug.png")
